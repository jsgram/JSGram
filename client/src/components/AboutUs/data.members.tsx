export const our_team = [
    ...
    },
    {
        ...
        info: 'Остап Дрібнюк, в IT недавно, багато помагаю іншим учасникам в тімі, тому що це важливо, ' +
            ...
            'також роблю різні завдання на фронті переважно бізнес логіка',
    },
    {
        id: '3',
        href: 'https://github.com/rostyk1331',
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThXhBwo6cqPjlO' +
            'SjbYhri-vV8bfOSxkohzS_zD9jHPia2AkDlM',
    ...
    },
    {
        ...
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTd_jKaKL5-m9re2p' +
            'oDCzjwCbqK-U62pW-5LDOGsv1Klgv_mh6nrA',
        username: 'Oleksiy Dorozhkin',
        info: 'Олексій Дорожкін, в IT давно, маю хороші і глибокі знання як в теорії так і в практиці, ' +
            'роблю все що треба, також + - хороші знання англійської, командний гравець, ' +
            'добре розраховую час на виконання завдань',
    },
    {
        id: '5',
        href: 'https://github.com/yuriimartynenko',
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhL-jHCVQMW9KyY-70' +
            'hFgaRtQ5B1KAPxu-5ZPhFKZiCmL8y-8q',
        username: 'Yurii Martinenko',
        info: 'Юрій Мартиненко, в IT майже рік, маю хороші знання з фронт розробки, верстаю все що бачу,' +
            ' роути за 2 хв роблю, хороші знання для створення логіки, бек не вчу бо в нас є Остап, командний я!',
    },
    {
        id: '6',
        href: 'https://github.com/IhorKalyta',
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPQYYQnEXfwWGMxxDOs' +
            'gxRMRjQKLy8bYDUZ5_SySy97lrTppZYqg',
        username: 'Ihor Kalyta',
        info: 'Ігор Калита, в ІТ недавно, стараюсь робити все почучуть, більше роблю фронт частину, ' +
            'наполегливий фіксаю добре баги, деколи ноут тупить але то нічо',
    },
    {
        id: '7',
        ...
        info: 'Я Володя, в IT зовсім не початківець, дуже круто виконую поставлені на себе завдання, ' +
            ...
            'роблю ui і деколи бізнес логіку, все взагалі супер :)',
    },
    {
        id: '8',
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz5FG9tUw40WJMH' +
            'OTvhYmJqXhu0mAOjjP_4dzS7Z3bULrLICZL',
