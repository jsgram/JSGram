...
export const setSubscribers = (
    loggedId: string, subscribers: [],
    page: number,
    ...
    payload: {loggedId, subscribers, page, followersCount, followingCount},
});
...
export const getSubscribers = (
    ...
    try {
        ...
        dispatch(setSubscribers(loggedId, res.data.users, page + 1, followersCount, followingCount));
    } catch (e) {
